...
export default class Home extends React.Component {
  ...
  render() {
    const children = [
      ...
      <Content1 id="content_4_0" key="content_4_0" isMobile={this.state.isMobile}/>,
      <Content2 id="content_9_0" key="content_9_0" isMobile={this.state.isMobile}/>,
      <Content3 id="content_2_0" key="content_2_0" isMobile={this.state.isMobile}/>,
